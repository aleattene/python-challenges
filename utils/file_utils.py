...
def print_day_results(
        year: str, day: str,
        demo_1: str, demo_2: str, demo_3: str,
        solution_1: str, solution_2: str, solution_3: str,
    ...
    title = f"Everybody Codes {year} – {day}"
    table = Table(
        title=title,
        style="bold white",
    ...
    table.add_column("Part 3", justify="right", header_style="bold blue", style=" bold blue")

    # Add rows with demo and solution results to the table
    table.add_row("Demo", str(demo_1), str(demo_2), str(demo_3), style="white")
    table.add_row("Solution", str(solution_1), str(solution_2), str(solution_3), style="", end_section=True)
